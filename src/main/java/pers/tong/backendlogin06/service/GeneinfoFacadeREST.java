...
import pers.tong.backendlogin06.Geneinfo;
...
public class GeneinfoFacadeREST extends AbstractFacade<Geneinfo> {
    ...
    public void create(Geneinfo entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Geneinfo entity) {
        super.edit(entity);
    }
    ...
    public Geneinfo find(@PathParam("id") Integer id) {
